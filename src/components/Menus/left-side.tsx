...
export const LeftSideMenu: React.FC<Props> = ({setOpen }) => {
  ...
  return (
    <nav className={`sticky   top-0 left-0 w-[200px] h-[100vh] px-[2rem] py-[0.75rem] bg-[#F7F8F9] lg:flex flex-col items-start`}>
      <div className="w-[120px] h-[30px] hidden lg:block mb-[30px]">
        <img
